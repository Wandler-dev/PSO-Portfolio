...
if port_in_use 8000; then
  echo "Port 8000 is already in use. Run scripts/stop_demo.sh or handle the process manually."
  exit 1
fi

if port_in_use 5173; then
  echo "Port 5173 is already in use. Run scripts/stop_demo.sh or handle the process manually."
  exit 1
fi
